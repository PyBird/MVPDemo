...
import com.onepeak.mvpdemo.R;
import com.onepeak.mvpdemo.utils.BarUtils;
...
public class BaseActivity extends AppCompatActivity {
    ...
    private boolean isChangeSystemBarColor = true;//是否改变状态栏颜色
    ...
    protected void onStart(){
        ...
        if(isChangeSystemBarColor){
            BarUtils.initSystemBarColor(this, BarUtils.getColor(this, R.color.colorPrimary));
        }
    }
     ...
     * @param isChange
     */
    public void setIsChangeSystemBarColor(boolean isChange) {
        isChangeSystemBarColor = isChange;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (!this.isFinishing()) {
            ...
            if (!(event.getRepeatCount() > 0) && !onPanelKeyDown(keyCode, event)) {
                ...
                Log.d(TAG, "baseactivity onKeyDown true");
                return true;
            }
    ...
    public void initSystemBarColor() {
        BarUtils.initSystemBarColor(this);
    }
